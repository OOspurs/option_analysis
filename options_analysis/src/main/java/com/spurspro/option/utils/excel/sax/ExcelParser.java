...
/**
 * ExcelParser
 * Created by Jimmy.Liu on 2018-10-26 15:23
 *
 * @since 2.01.06
 */
...
//          this.columsLength = columsLength;
    ...
    public static void main(String[] args) throws Exception {
        double totalAmount = Double.parseDouble("4,000.00");
        
        File tempFile = new File("D:\\dataImport\\tongluowang\\medik-buy.xlsx");
        ...
        System.out.println("行数: " + datas.size());
    }
}
